# Credits to Crowplexus! this was modified a bit to fit my needs but otherwise all code here was done by her
# https://github.com/crowplexus/Funkin-Raven/blob/rewrite/scenes/ui/alphabet.gd
@tool extends Control
class_name Alphabet

@export var texture: SpriteFrames = preload("res://assets/images/general/bold.xml")
...
func get_animation(character: String) -> String:
	match character:
		...
		"]": return "]"
		"^": return "^"
		#"|": return: "|" damn guess this can't be used??
		"~": return "~"
		_:
