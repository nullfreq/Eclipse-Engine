# yoinked from https://godotshaders.com/shader/spectrum-analyzer/ + slightly modified
extends Control

const VU_COUNT = 30
const FREQ_MAX = 48000.0
const MIN_DB = 60
...
func start(busIDX:int):
	spectrum = AudioServer.get_bus_effect_instance(busIDX, 0)
